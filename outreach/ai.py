...
Return JSON {{"candidates":[{{"name":"full public name","email":"published email","persona":"{persona}","bio":"short factual introduction","fit_reason":"why this current activity fits","contact_url":"HTTPS exact email source page","profile_url":"HTTPS activity evidence page on the same owner site or an official institution staff page","fit_quote":"10-25 word exact quote","country_code":"US, GB, DE, FR, ES, IT, NL, JP, BR, CA, MX, AU, IN or UNKNOWN","country_quote":"exact current owner location quote; no clients, past locations or unsupported country guesses"}}]}}.'''
    ...
    def initial_copy(self,contact,brief=None,revision_feedback=''):
        ...
        result,_=self.call(
            ...
            'selected_chapter_ids is an array of integer chapter IDs (may be empty), but if offering a chapter recommendation it must contain exactly the one chapter you will deliver in a reply. '
            ...
            'Do not claim improved speed, success or gap detection versus a single pass without actual evidence. '
    ...
    def _review(self,purpose,context,subject,body):
        ...
        result,_=self.call(
            ...
            'Reject unsupported performance comparisons such as claiming advisor review catches more gaps without evidence. '
            ...
            'For replies answer actual fresh incoming text, fulfill the exact saved example or promised chapter first, do not repitch to someone reading. '
    ...
    def reply_copy(self,context):
        ...
        result,_=self.call('Write a complete reply using ONLY supplied book facts, fresh inbound text and saved offer. '
            ...
            'If a chapter recommendation was offered and the reader responds, deliver the saved selected chapter first, '
            'using its actual supplied title and description; include that chapter ID in selected_chapter_ids. '
