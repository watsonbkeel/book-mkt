...
@pytest.mark.parametrize('old_version',['1.0.0','1.1.0'])
...
if 'cp' in args:
 ...
 pathlib.Path(args[-1]).write_bytes(b'test-backup')
''');docker.chmod(0o755)
